...
<div class="container">
    <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
            <p>En vous créant un compte, vous pourrez me laisser vos commentaires sur les derniers chapitres et ainsi me
                dire ce que vous en pensez !</p>
            <div id="succes">
                <div class="alert alert-error">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">x</button>
                    <strong>Les mots de passe saisis ne sont pas identiques !</strong>
                </div>
            </div>
            <form method="post" action="../Model/data-form-create-account.php">
                ...
                <div class="control-group">
                    <div class="form-group col-xs-12 floating-label-form-group controls">
                        ...
                        <input type="tel" class="form-control" placeholder="Pseudo (identifiant de connexion)"
                               id="phone" required
                ...
                <div class="control-group">
                    <div class="form-group floating-label-form-group controls">
                        <label>Password</label>
                        <input type="password" class="form-control" placeholder="Confirmation du mot de passe" id="name"
                               required
