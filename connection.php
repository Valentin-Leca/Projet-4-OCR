...
<div class="container">
    <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
            ...
            <form name="connection" method="post" action="request-sql-connection-account.php">
                ...
                <div class="form-group">
                    ...
                    <p class="subheading">Si vous ne possédez pas de compte, cliquez <a href="create-account.php"><span id="underline_3">ici</span></a> pour en créer un !</p>
                </div>
            </form>
        </div>
    </div>
